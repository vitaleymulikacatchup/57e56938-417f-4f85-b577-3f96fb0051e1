...
export const metadata: Metadata = {
  title: "Boulangerie Française - Artisanat Traditionnel Paris",
  description: "Découvrez notre boulangerie artisanale parisienne. Pains, viennoiseries et pâtisseries préparés selon les méthodes traditionnelles françaises.",
  keywords: ["boulangerie", "artisan", "pain français", "croissant", "pâtisserie", "Paris", "traditionnel"],
  openGraph: {
    title: "Boulangerie Française - Artisanat Traditionnel",
    description: "Boulangerie artisanale parisienne - Traditions françaises depuis 3 générations",
    siteName: "Boulangerie Française",
    type: "website",
    images: [{
      url: "https://images.pexels.com/photos/32459865/pexels-photo-32459865.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
      alt: "Boulangerie française artisanale"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Boulangerie Française - Artisanat Traditionnel",
    description: "Découvrez nos créations artisanales préparées selon les méthodes traditionnelles françaises",
    images: ["https://images.pexels.com/photos/32459865/pexels-photo-32459865.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
...
`
        ...
        />
        <script async defer data-website-id="ANALYTIC_WEBSITE_UUID" src="https://analytics.webild.io/script.js"></script>
